...
import io.github.nety.integrationcheck.mapper.CheckMapper;
import io.github.nety.integrationcheck.service.processor.CheckProcessor;
import io.github.nety.integrationcheck.service.reader.CheckReader;
import io.github.nety.integrationcheck.service.writer.CheckResultWriter;
import io.github.nety.integrationcheck.service.writer.CheckWriter;
...
public class CheckExecutionService implements CheckExecution {
    ...
    public void execute(long checkId) {
        try {
            var checkEntity = checkReader.findById(checkId);
